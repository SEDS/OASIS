...
# $Id: local_dac_no_handler.pl 2142 2012-03-26 18:02:24Z dfeiock $
# -*- perl -*-
...
my $output_file = 'local_dac_no_handler.csv';
...
# Start the DAC
$the_DAC_options = "-ORBEndpoint iiop://localhost:20000 --name=StandardDAC -c no_handler.dac --database=StandardDAC.db";
