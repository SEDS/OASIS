 ...
 *
 *  $Id: Memory_Data_Observer.h 2099 2012-01-09 22:28:58Z dfeiock $
 *
 *  @author     Harold Owens II
 */
//=============================================================================

#ifndef _OASIS_MEMORY_DATA_OBSERVER_OBSERVER_H_
#define _OASIS_MEMORY_DATA_OBSERVER_OBSERVER_H_
 ...
 */
class Memory_Data_Observer : public PlatformMemoryProbe::AbstractObserver
{
public:
  /// Default constructor.
  Memory_Data_Observer (size_t iterations);

  /// Destructor.
  virtual ~Memory_Data_Observer (void);
