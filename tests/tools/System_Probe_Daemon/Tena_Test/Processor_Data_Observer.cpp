// $Id: Processor_Data_Observer.cpp 2123 2012-01-23 17:23:03Z dfeiock $
...
//
// Processor_Data_Observer
//
Processor_Data_Observer::Processor_Data_Observer (size_t iterations)
: cond_ (lock_),
...
// ~Processor_Data_Observer
//
Processor_Data_Observer::~Processor_Data_Observer (void)
{
...
// wait
//
void Processor_Data_Observer::wait (void)
{
  ACE_GUARD (ACE_Thread_Mutex, guard, this->lock_);
  this->cond_.wait ();
}
