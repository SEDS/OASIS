...
# $Id: run_test.pl 2119 2012-01-18 14:04:00Z dfeiock $
# -*- perl -*-
...
$the_Client_App = new PerlACE::Process ("OASIS_Tena_Temperature_Pub_Sub_Test_Subscriber", $the_Client_App_options);
...
$the_App_options = "-d --config=test.einode";
$the_App = new PerlACE::Process ("OASIS_Tena_Temperature_Pub_Sub_Test", $the_App_options);
$the_App->Spawn ();
