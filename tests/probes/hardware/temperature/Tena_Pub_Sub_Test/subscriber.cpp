// $Id: subscriber.cpp 2111 2012-01-12 21:03:49Z dfeiock $
...
int main (int argc, char * argv [])
{
  try
  {
    ...
    PlatformTemperatureProbe::SubscriptionPtr subscription (new PlatformTemperatureProbe::Subscription ());
    OASIS::Test::Data_Observer * data_observer = new OASIS::Test::Data_Observer (10);
    PlatformTemperatureProbe::AbstractObserverPtr observer (data_observer);
    subscription->addObserver (observer);

    PlatformTemperatureProbe::subscribe (*session, subscription, false);
    ...
    PlatformTemperatureProbe::unsubscribe (*session);
