...
namespace Test
{
  ...
  // BImpl::__metadata__
  // 
  const ::Test::B_Metadata BImpl::__metadata__ =
  ::Test::B_Metadata ();
  ...
  // BImpl::metadata
  // 
  const ::Test::B_Metadata & BImpl::metadata (void) const 
  {
    return ::Test::BImpl::__metadata__;
  }
  ...
  // CImpl::__metadata__
  // 
  const ::Test::C_Metadata CImpl::__metadata__ =
  ::Test::C_Metadata ();
  ...
  // CImpl::metadata
  // 
  const ::Test::C_Metadata & CImpl::metadata (void) const 
  {
    return ::Test::CImpl::__metadata__;
  }
  ...
  {
    if (0 != ::Test::BImpl::package_data (p))
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT ("%T (%t) - %M - failed to package data\n")),
                        -1);
