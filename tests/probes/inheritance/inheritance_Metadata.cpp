...
namespace Test
{
  ...
  " elementFormDefault='qualified'"
  " version='1.0'>"
  "<xsd:element name='probeMetadata' type='Test.B' />"
  "<xsd:complexType name='Test.B'>"
  "<xsd:complexContent>"
  ...
  " elementFormDefault='qualified'"
  " version='1.0'>"
  "<xsd:element name='probeMetadata' type='Test.C' />"
  "<xsd:complexType name='Test.C'>"
  "<xsd:complexContent>"
  "<xsd:extension base='Test.B'>"
  "<xsd:sequence>"
  ...
  C_Metadata::C_Metadata (const char * uuid,
                          ...
                          ACE_UINT8 version_minor,
                          const char * schema)
  : ::Test::B_Metadata (uuid, type_info, version_major, version_minor, schema)
  {
  }
