// $Id: subscriber.cpp 2005 2011-10-10 23:28:09Z dfeiock $
...
int main (int argc, char * argv [])
{
  try
  {
    ...
    PlatformProcessorProbe::SubscriptionPtr subscription (new PlatformProcessorProbe::Subscription ());
    OASIS::Test::Data_Observer * data_observer = new OASIS::Test::Data_Observer (10);
    PlatformProcessorProbe::AbstractObserverPtr observer (data_observer);
    subscription->addObserver (observer);

    PlatformProcessorProbe::subscribe (*session, subscription, false);
