...
$the_Client_App = new PerlACE::Process ("OASIS_Tena_Processor_Pub_Sub_Test_Subscriber", $the_Client_App_options);
...
$the_App = new PerlACE::Process ("OASIS_Tena_Processor_Pub_Sub_Test", $the_App_options);
$the_App->Spawn ();
