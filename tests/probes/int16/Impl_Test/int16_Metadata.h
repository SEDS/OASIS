...
#ifndef _INT16_METADATA_H_
#define _INT16_METADATA_H_
...
{
  /**
   * @class Int16_SoftwareProbe_Metadata
   */
  class Int16_SoftwareProbe_Metadata :
    public ::OASIS::Software_Probe_Metadata 
  {
    public:
    /// Default constructor
    Int16_SoftwareProbe_Metadata (void);

    /// Destructor
    virtual ~Int16_SoftwareProbe_Metadata (void);

    protected:
    /// Initalizing constructor
    Int16_SoftwareProbe_Metadata (const char * uuid,
...
#endif  // !defined __INT16_METADATA_H__
