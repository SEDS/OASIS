...
namespace OASIS
{
    ...
    public virtual ::OASIS::Software_Probe 
  {
    ...
    typedef ::OASIS::Int16_SoftwareProbe_Metadata METADATA_TYPE;

    /// The metadata for the software probe.
    static const METADATA_TYPE __metadata__;

    /// Default constructor
    Int16_SoftwareProbe (void);

    /// Destructor
    virtual ~Int16_SoftwareProbe (void);
