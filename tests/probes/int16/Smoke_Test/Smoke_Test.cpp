...
bool servant_test (::OASIS::Standard_EINode & einode)
{
  try
  {
    ...
    ::OASIS::Int16_SoftwareProbeImpl probe_impl;

    if (0 != probe_impl.init ("--name=Int16ProbeImpl"))
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT ("%T (%t) - %M - failed to initalize probe_impl\n")),
                         1);
