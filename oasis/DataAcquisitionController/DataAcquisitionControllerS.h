...
#ifndef _TAO_IDL_DATAACQUISITIONCONTROLLERS_99MA3C_H_
#define _TAO_IDL_DATAACQUISITIONCONTROLLERS_99MA3C_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::OASIS::RemoteServiceList>
    : public
  ...
  template<>
  class SArg_Traits< ::OASIS::ProbeInstance>
    : public
        Var_Size_SArg_Traits_T<
            ::OASIS::ProbeInstance,
            TAO::Any_Insert_Policy_Noop
  ...
  template<>
  class SArg_Traits< ::OASIS::ProbeInstanceList>
    : public
        Var_Size_SArg_Traits_T<
...
#if !defined (_OASIS_DATAACQUISITIONCONTROLLER__SARG_TRAITS_)
#define _OASIS_DATAACQUISITIONCONTROLLER__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::OASIS::DataAcquisitionController>
    : public
...
namespace POA_OASIS
{
  ...
  class OASIS_DAC_SKEL_Export DataAcquisitionController
  ...
  public:
    ...
    typedef ::OASIS::DataAcquisitionController _stub_type;
    typedef ::OASIS::DataAcquisitionController_ptr _stub_ptr_type;
    typedef ::OASIS::DataAcquisitionController_var _stub_var_type;

    DataAcquisitionController (const DataAcquisitionController& rhs);
    ...
    ::OASIS::DataAcquisitionController *_this (void);
    ...
    static void get_probe_instances_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
