// $Id: HardwareProbe_Bridge.cpp 2211 2012-07-25 12:55:51Z dfeiock $

#include "HardwareProbe_Bridge.h"
...
namespace OASIS
{
  namespace HardwareProbes
  {
    ...
    // _create
    //
    ::OASIS::Software_Probe_Bridge * HardwareProbe_Bridge::_create (void)
    {
      ::OASIS::Software_Probe_Bridge * bridge = 0;
      ACE_NEW_RETURN (bridge,
                      HardwareProbe_Bridge (),
                      0);
    ...
    // HardwareProbe_Bridge
    //
    HardwareProbe_Bridge::HardwareProbe_Bridge (void)
    {
    ...
    publish (const ::OASIS::DAC::Data_Packet & packet)
    {
      ...
      ::OASIS::HardwareProbes::HardwareProbe::ServantPtr servant = iter->second;
      ...
      std::auto_ptr < ::OASIS::HardwareProbes::HardwareProbe::PublicationStateUpdater >
    ...
    update (PublicationStateUpdater & updater, ACE_InputCDR & input)
    {
      ...
      using namespace ::OASIS::HardwareProbes::HardwareProbe;
      return 0;
    }
