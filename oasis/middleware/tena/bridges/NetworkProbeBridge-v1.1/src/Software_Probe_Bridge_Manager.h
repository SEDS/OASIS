...
#ifndef _OASIS_NETWORKPROBE_V1_1_SOFTWARE_PROBE_BRIDGE_MANAGER_H_
#define _OASIS_NETWORKPROBE_V1_1_SOFTWARE_PROBE_BRIDGE_MANAGER_H_

#include "oasis/middleware/tena/bridges/Software_Probe_Bridge_Manager.h"
#include "NetworkProbeBridge_v1_1_export.h"
...
namespace NetworkProbeBridge_v1_1
{
   ...
   * probe bridges from the OASIS-NetworkProbe-v1.1
   * object model.
   */
  class Software_Probe_Bridge_Manager :
...
OASIS_TENA_SOFTWARE_BRIDGE_MANAGER_EXPORT_DECL (NETWORKPROBEBRIDGE_V1_1_Export);

#endif  // !defined _OASIS_NETWORKPROBE_V1_1_SOFTWARE_PROBE_BRIDGE_MANAGER_H_
