...
//=============================================================================
/**
 * @file        LinuxProcessorProbe_Bridge.h
 *
 * $Id: LinuxProcessorProbe_Bridge.h 2135 2012-02-16 15:39:18Z dfeiock $
 *
 * @author      James H. Hill
 */
//=============================================================================

#ifndef _OASIS_SYSTEM_PROCESSOR_LINUXPROCESSORPROBE_LINUXPROCESSORPROBE_BRIDGE_H_
#define _OASIS_SYSTEM_PROCESSOR_LINUXPROCESSORPROBE_LINUXPROCESSORPROBE_BRIDGE_H_
...
namespace OASIS
{
  namespace System
  {
    namespace Processor
    {
      ...
      /**
       * @class LinuxProcessorProbe_Bridge
       *
       * Software probe bridge for OASIS::System::Processor::LinuxProcessorProbe.
       */
      class LinuxProcessorProbe_Bridge :
        public ::OASIS::Software_Probe_Bridge_T < ::OASIS::System::Processor::LinuxProcessorProbe_SDO >
      {
      public:
        /// Type definition of the base type.
        typedef ::OASIS::Software_Probe_Bridge_T < ::OASIS::System::Processor::LinuxProcessorProbe_SDO > base_type;

        /// Static factory method.
        static ::OASIS::Software_Probe_Bridge * _create (void);

        /// Default constructor.
        LinuxProcessorProbe_Bridge (void);

        /// Destructor.
        virtual ~LinuxProcessorProbe_Bridge (void);
        ...
        typedef ::OASIS::System::Processor::LinuxProcessorProbe::PublicationStateUpdater PublicationStateUpdater;
...
#endif  // !defined _OASIS_SYSTEM_PROCESSOR_LINUXPROCESSORPROBE_LINUXPROCESSORPROBE_BRIDGE_H_
