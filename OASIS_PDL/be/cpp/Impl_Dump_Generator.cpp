// $Id: Impl_Dump_Generator.cpp 2214 2012-08-10 15:00:08Z dfeiock $
...
// ~Impl_Dump_Generator
//
Impl_Dump_Generator::~Impl_Dump_Generator (void)
{
...
// ~Impl_Dump_Variable_Generator
//
Impl_Dump_Variable_Generator::~Impl_Dump_Variable_Generator (void)
{
...
// name
//
void Impl_Dump_Variable_Generator::name (const ::std::string & name)
{
  this->name_ = name;
}
...
// parent_is_probe
//
void Impl_Dump_Variable_Generator::parent_is_probe (const bool & parent)
{
...
// visit_probe
//
void Impl_Dump_Generator::visit_probe (const OASIS_PDL_Probe & p)
{
  ...
  this->hfile_
    << std::endl
    << "public:" << std::endl
    << "/// Impl_Dump the software probe's data." << std::endl
  ...
  this->cppfile_
    ...
    if (!p.members ().empty ())
    {
      Impl_Dump_Variable_Generator var_gen (this->hfile_, this->cppfile_);
...
// visit_struct
//
void Impl_Dump_Generator::visit_struct (const OASIS_PDL_Struct & s)
{
  this->hfile_
    << "/// Impl_Dump method for for ::" << s.fq_name ("::") << "Impl" << std::endl
...
// visit_probe
//
void Impl_Dump_Variable_Generator::visit_probe (const OASIS_PDL_Probe & p)
{
...
// visit_struct
//
void Impl_Dump_Variable_Generator::visit_struct (const OASIS_PDL_Struct & s)
{
  if (this->parent_is_probe_)
  {
    this->cppfile_
...
// visit_simple_type
//
void Impl_Dump_Variable_Generator::visit_simple_type (const OASIS_PDL_Simple_Type & s)
{
  if (this->parent_is_probe_)
  {
    this->cppfile_
...
// visit_vector_type
//
void Impl_Dump_Variable_Generator::visit_vector_type (const OASIS_PDL_Vector_Type & v)
{
  const char * suffix;
  if (this->parent_is_probe_)
    suffix = "_";
