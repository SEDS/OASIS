...
//=============================================================================
/**
 * @file      Stub_Dump_Generator.h
 *
 *  $Id: Stub_Dump_Generator.h 2214 2012-08-10 15:00:08Z dfeiock $
 *
 *  @author   Dennis Feiock
 */
//=============================================================================

#ifndef _OASIS_PDL_BE_CPP_STUB_DUMP_GENERATOR_H_
#define _OASIS_PDL_BE_CPP_STUB_DUMP_GENERATOR_H_
...
/**
 * @class Stub_Dump_Generator
 *
 * Visitor that generates the dump implementation.
 */
class Stub_Dump_Generator : public OASIS_PDL_Visitor
{
public:
  /**
  ...
  /// Destructor.
  virtual ~Stub_Dump_Generator (void);
...
/**
 * @class Stub_Dump_Variable_Generator
 *
 * Visitor that generates the dump implementation based
 * on its type.
 */
class Stub_Dump_Variable_Generator : public OASIS_PDL_Visitor
{
public:
  /**
   * Initializing constructor.
  ...
  /// Destructor.
  virtual ~Stub_Dump_Variable_Generator (void);
