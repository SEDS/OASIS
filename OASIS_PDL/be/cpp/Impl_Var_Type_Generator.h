...
//=============================================================================
/**
 * @file      Impl_Var_Type_Generator.h
 *
 *  $Id: Impl_Var_Type_Generator.h 2211 2012-07-25 12:55:51Z dfeiock $
 *
 *  @author   James H. Hill
 */
//=============================================================================
...
/**
 * @class Impl_Var_Type_Generator
 *
 * Visitor that generates a variable's type declaration.
 */
class Impl_Var_Type_Generator : public OASIS_PDL_Visitor
{
public:
  /**
   ...
   */
  Impl_Var_Type_Generator (std::ostream & out, bool ending = false);

  /// Destructor.
  virtual ~Impl_Var_Type_Generator (void);
