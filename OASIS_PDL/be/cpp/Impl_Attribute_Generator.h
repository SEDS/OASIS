...
//=============================================================================
/**
 * @file      Impl_Attribute_Generator.h
 *
 *  $Id: Impl_Attribute_Generator.h 2211 2012-07-25 12:55:51Z dfeiock $
 *
 *  @author   James H. Hill
 */
//=============================================================================

#ifndef _OASIS_PDL_BE_CPP_IMPL_ATTRIBUTE_GENERATOR_H_
#define _OASIS_PDL_BE_CPP_IMPL_ATTRIBUTE_GENERATOR_H_
...
/**
 * @class Impl_Attribute_Generator
 *
 * Visitor that generates a variable's type declaration.
 */
class Impl_Attribute_Generator : public OASIS_PDL_Visitor
{
public:
  /**
  ...
  /// Destructor.
  virtual ~Impl_Attribute_Generator (void);
