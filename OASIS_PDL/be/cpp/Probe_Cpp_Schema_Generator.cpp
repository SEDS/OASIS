// $Id: Probe_Cpp_Schema_Generator.cpp 2211 2012-07-25 12:55:51Z dfeiock $
...
//
// OASIS_PDL_Probe_Cpp_Schema_Generator
//
OASIS_PDL_Probe_Cpp_Schema_Generator::
...
//
OASIS_PDL_Probe_Cpp_Schema_Generator::
~OASIS_PDL_Probe_Cpp_Schema_Generator (void)
{
...
// visit_probe
//
void OASIS_PDL_Probe_Cpp_Schema_Generator::
visit_probe (const OASIS_PDL_Probe & probe)
{
  OASIS_PDL_Schema_Type_Generator type_gen (this->cppfile_);
  ...
  if (!this->inner_probe_)
  {
    ...
    this->cppfile_ << "\"<xsd:element name='probeMetadata' type='";
    probe.accept (type_gen);
    this->cppfile_ << "' />\"" << std::endl;
  ...
  if (!this->inner_probe_)
    this->cppfile_ << quote ("</xsd:schema>") << ";";
}
...
// complex_type_end
//
void OASIS_PDL_Probe_Cpp_Schema_Generator::complex_type_end (void)
{
  if (!this->in_complex_)
    this->cppfile_
