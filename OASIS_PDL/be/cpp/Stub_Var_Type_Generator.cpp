// $Id: Stub_Var_Type_Generator.cpp 2211 2012-07-25 12:55:51Z dfeiock $
...
//
// Stub_Var_Type_Generator
//
Stub_Var_Type_Generator::
Stub_Var_Type_Generator (std::ostream & out, bool ending)
: out_ (out),
  ending_ (ending)
{
...
// ~Stub_Var_Type_Generator
//
Stub_Var_Type_Generator::~Stub_Var_Type_Generator (void)
{
...
// visit_struct
//
void Stub_Var_Type_Generator::visit_struct (const OASIS_PDL_Struct & s)
{
  this->out_ << "::" << s.fq_name ("::");
}
...
// visit_vector_type
//
void Stub_Var_Type_Generator::visit_vector_type (const OASIS_PDL_Vector_Type & v)
{
